...
for /R "%~dp0_ark\ps4\songs" %%f in (*.dta_dta_ps4) do move "%%f" "%%~dpnf.dta_dta_ps3"
for /R "%~dp0_ark\ps4\songs" %%f in (*.moggsong_dta_ps4) do move "%%f" "%%~dpnf.moggsong_dta_ps3"
for /R "%~dp0_ark\ps4\songs" %%f in (*.png_ps4) do move "%%f" "%%~dpnf.png_ps3"
for /R "%~dp0_ark\ps4\songs" %%f in (*.mid_ps4) do move "%%f" "%%~dpnf.mid_ps3"
