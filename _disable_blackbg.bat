...
xcopy /e /y "%~dp0dx_optional_additions\_revert_to_default\ps3blkbg" "%~dp0_build\modulate\ps3\world
...
xcopy /e /y "%~dp0dx_optional_additions\_revert_to_default\ps4blkbg" "%~dp0_build\modulate\ps4\world
pause